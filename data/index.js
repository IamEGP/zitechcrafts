import logoLight from "@/images/zitechcrafts-logo-color.svg";
import logoDark from "@/images/zitechcrafts-logo-1.svg";
...
import sliderOne01 from "@/images/slider/wave.png";
import sliderOne02 from "@/images/slider/banner.png";
...
export const ContactInfosList = [
  {
    ...
    infos: [
      {
        name: "43 Central Avenue, Harare"
      },
      {
        name: "support@zitechcrafts.com"
      },
      {
        name: "+263 78 866 4774"
      }
    ]
  },
  {
  ...
  },
  {
    ...
    infos: [
      ...
      {
        name: "training@zitechcrafts.com"
      },
      {
        name: "+263 78 866 4774"
      }
...
export const ContactFormTitle = {
  ...
  description:
    "Our thrive is to provide tech alignment in business solution guided by seamless, easy customer experience. "
};
...
export const ServicePostTwoData = {
  sectionContent: {
    title: "Industry leading technology innovations \n by Africa, for Africa & beyond.",
    subTitle: "ZiTech Crafts"
  },
  posts: [
    {
...
export const ParallaxOneData = {
  iconName: "mei-team",
  title: "We made providing business solutions that are in aligment with the most contemporary international standards.",
  specialText: "They are done by Africa, for Africa & Beyond!",
  text:
    "We attribute ourselves with high flair easy to use custom tech solutions that help accelerate, automate & innovate business solutions according to the clients' desired niche. This is executed to bringing up business giants that are well though"
};
...
import aboutTwo01 from "@/images/home_1/meeting.jpg";
import aboutTwo02 from "@/images/home_1/imac.jpg";

export const AboutTwoData = {
  sectionContent: {
    title: "Work with the best business intelligence strategists.",
    subTitle: "ZiTech Crafts, business technology alignement by Africa for Africa & beyond!",
    text:
      "We specialize in providing long lasting scalable technology solutions.  Our mandate is thriving to deliver custom solutions deployed to render problem solving solutions relying on internationally recognised standards."
  },
  button: {
